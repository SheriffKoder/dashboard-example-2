...
export const metadata: Metadata = {
  title: "Extrados | Cryptocurrency Portfolio Dashboard",
  description: "Real-time cryptocurrency portfolio dashboard with interactive data visualization, master filtering, and advanced search capabilities.",
};
